...
class CTokenizer():
    def __init__(self):
        ...
        self.lib.createTokenizer.argtypes = [
            ctypes.c_char_p
        ]
        ...
        self.tokenizer_p = self.lib.createTokenizer("solution/resources/tokenizer_vocab.bin".encode())
    ...
    def encode(self, string):
        ...
        self.lib.tokenize(self.tokenizer_p, string.encode(), ctypes.byref(num_tokens), ctypes.byref(tokens))
